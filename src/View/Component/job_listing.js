...
export default function JobListing() {
    return (
        <Container>
            ...
            <Row style={{ display: "grid", gridTemplateColumns: "1fr 2fr", padding: "20px" }}>
                <Col xl={4} lg={4} md={4} style={{ placeItems: "center", padding: "20px", marginLeft: "80px" }}>
                    <Row>
                        <Col  >
                    ...
                    <Container>
                        ...
                        <Row>
                            <Card style={{ width: '1000px' }}>
                                <Card.Img variant="top" src={icons} style={{ width: "60px", height: "60px" }} />
                                <Card.Body>
